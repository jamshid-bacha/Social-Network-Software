...
class FollowingCyberbully extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowingCyberbully(
      ...
      : super(key: key);
  @override
  _FollowingCyberbully createState() => _FollowingCyberbully();
}

class _FollowingCyberbully extends State<FollowingCyberbully> {
  @override
