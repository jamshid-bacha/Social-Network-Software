...
class FollowerListMention extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowerListMention(
      ...
      : super(key: key);
  @override
  _FollowerListMention createState() => _FollowerListMention();
}

class _FollowerListMention extends State<FollowerListMention> {
