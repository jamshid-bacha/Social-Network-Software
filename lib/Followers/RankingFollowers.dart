...
import '../Followers/followerListRetweets.dart';
import '../Followers/followerListLikes.dart';
import '../Followers/followerListMention.dart';
import '../Followers/followerListReply.dart';
import '../screens/twitterDrawerList.dart';
import 'package:http/http.dart' as http;

class RankingFollowers extends StatefulWidget {
  ...
  const RankingFollowers(
      ...
      : super(key: key);
  @override
  _RankingFollowers createState() => _RankingFollowers();
}

class _RankingFollowers extends State<RankingFollowers> {
                      ...
                      onTap: () async {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FollowerListRetweets(
                                      displayName: widget.displayName,
                      ...
                      onTap: () async {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FollowerListLikes(
                                    displayName: widget.displayName,
                                    photoURL: widget.photoURL,
                                    username: widget.username,
                                    following: widget.following,
                      ...
                      onTap: () async {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FollowerListReply(
                                      displayName: widget.displayName,
                                      photoURL: widget.photoURL,
                                      username: widget.username,
                                      following: widget.following,
                      ...
                      onTap: () async {
                        ...
                        if (response.statusCode == 200) {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FollowerListMention(
                                      displayName: widget.displayName,
                                      photoURL: widget.photoURL,
                                      username: widget.username,
                                      following: widget.following,
