...
class FollowerListLikes extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowerListLikes(
      ...
      : super(key: key);
  @override
  _FollowerListLikes createState() => _FollowerListLikes();
}

class _FollowerListLikes extends State<FollowerListLikes> {
  @override
