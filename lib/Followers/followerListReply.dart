...
class FollowerListReply extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowerListReply(
      ...
      : super(key: key);
  @override
  _FollowerListReply createState() => _FollowerListReply();
}

class _FollowerListReply extends State<FollowerListReply> {
