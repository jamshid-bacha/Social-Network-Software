...
class FollowingsListLikes extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowingsListLikes(
      ...
      : super(key: key);
  @override
  _FollowingsListLikes createState() => _FollowingsListLikes();
}

class _FollowingsListLikes extends State<FollowingsListLikes> {
  @override
