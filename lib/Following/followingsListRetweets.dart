...
class FollowingsListRetweets extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowingsListRetweets(
      ...
      : super(key: key);
  @override
  _FollowingsListRetweets createState() => _FollowingsListRetweets();
}

class _FollowingsListRetweets extends State<FollowingsListRetweets> {
  @override
