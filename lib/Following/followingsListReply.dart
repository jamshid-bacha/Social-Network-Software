...
class FollowingsListReply extends StatefulWidget {
  final displayName;
  final photoURL;
  var username;
  var following;
  ...
  FollowingsListReply(
      ...
      : super(key: key);
  @override
  _FollowingsListReply createState() => _FollowingsListReply();
}

class _FollowingsListReply extends State<FollowingsListReply> {
